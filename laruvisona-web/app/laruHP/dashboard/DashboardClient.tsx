...
const TOOL_GROUPS: { title: string; caption: string; items: { href: string; label: string; accent: string; badge?: 'contacts'; icon: React.ReactNode }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/laruHP/booking/schedule', label: '予約管理', accent: 'sky', icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/laruHP/payments', label: '旧決済リンク', accent: 'sky', icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg> },
