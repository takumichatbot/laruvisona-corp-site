...
const PLAN_LABELS: Record<string, { name: string; price: string; color: string }> = {
  ...
  'hp-bot':     { name: 'HP + Bot Standard',             price: '¥4,980/月',  color: 'text-indigo-600 bg-indigo-50 border-indigo-200' },
          ...
          {gscLoading ? (
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <path fill="#34A853" d="M12 24c3.11 0 5.72-1.03 7.62-2.8l-3.72-2.89c-1.03.69-2.35 1.1-3.9 1.1-3 0-5.54-2.03-6.45-4.75H1.7v2.98A11.99 11.99 0 0 0 12 24z"/>
                <path fill="#FBBC05" d="M5.55 14.66a7.2 7.2 0 0 1 0-4.6V7.08H1.7a12 12 0 0 0 0 10.56l3.85-2.98z"/>
                <path fill="#EA4335" d="M12 4.75c1.69 0 3.2.58 4.4 1.72l3.3-3.3C17.71 1.2 15.1 0 12 0 7.3 0 3.25 2.7 1.7 7.08l3.85 2.98C6.46 7.34 9 4.75 12 4.75z"/>
              </svg>
              Googleアカウントで連携する
            </a>
          ) : (
