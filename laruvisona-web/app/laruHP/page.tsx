...
const FAQ_ITEMS = [
  ...
  {
    q: 'なぜ6ヶ月の最低契約期間があるのですか？途中解約は？',
    a: '初月無料と、AIによる初期サイト生成・セットアップのコストを月額999円に含めているため、6ヶ月の最低利用期間を設けています。恐れ入りますが期間中の解約はできません。7ヶ月目以降は、ダッシュボードのサブスクリプション管理画面またはメール（info@laruvisona.jp）から翌月末までにお申し込みいただければ、翌月から課金を停止します。',
  },
  {
    q: '年払いプランはありますか？',
