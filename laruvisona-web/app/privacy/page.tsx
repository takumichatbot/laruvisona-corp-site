...
const SECTIONS = [
  ...
  {
    title: '5. Cookieの使用',
    content: `本サイトはアクセス解析のためCookieを使用する場合があります。Cookieはブラウザの設定から無効にできますが、一部機能が使えなくなる場合があります。`,
  },
  {
    title: '6. 個人情報の管理・保護',
    content: `当社は個人情報への不正アクセス・紛失・破損・改ざん・漏洩を防ぐため、適切なセキュリティ対策を実施します。`,
  },
  {
    title: '7. 開示・訂正・削除',
  ...
  {
    title: '8. ポリシーの変更',
    content: `当社は本ポリシーを必要に応じて改定します。重要な変更がある場合はサービス内またはメールでお知らせします。`,
  },
  {
    title: 'お問い合わせ窓口',
